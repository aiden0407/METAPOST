...
export const getCommunityInfo = async function (accessToken, communityId, type, offset) {
  try {
    let options = {
...
export const createCommunity = async function (accessToken, name, description, logo, banner) {
  try {
    let options = {
