...
function Login() {
  ...
  return (
    <LoginContainer>
      ...
      <Text H5 medium color={COLOR.N700} marginTop={40}>
        E-mail
      </Text>
      <BorderInput
        type="text"
        ...
        marginTop={8}
      />
      <Text H5 medium color={COLOR.N700} marginTop={16}>
        Password
      </Text>
      <BorderInput
        type="password"
      ...
      <Row marginTop={24}>
        ...
        />
        <Text H5 medium color={COLOR.N700} marginLeft={8}>
          Remember me
        </Text>
        <FlexBox />
        <SignInButton onClick={() => handleSignIn()}>
          <Text B0 medium color={COLOR.BLUE1}>
            Sign in
          </Text>
        </SignInButton>
      </Row>
      ...
      {isWalletClicked ? (
        ...
        <ConnectWalletButton onClick={() => handleWalletClick()}>
          <Row>
            ...
            <Text H5 bold color="#FFFFFF" marginLeft={4}>
              Connect with Wallet
            </Text>
          </Row>
        </ConnectWalletButton>
      ...
      <Row marginTop={24}>
        ...
        <FlexBox />
        <Text B1 medium color={COLOR.N700}>
          Need an account?
        </Text>
        <StyledText
          B1
          ...
          color={COLOR.BLUE1}
          marginLeft={6}
          onClick={() => handleNavigateSignUpEmail()}
        >
          Sign up
        </StyledText>
      </Row>
